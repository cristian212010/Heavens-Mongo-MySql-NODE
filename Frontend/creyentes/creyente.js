...
async function loadData() {
    ...
    informacion.forEach((info) => {
        ...
        <div class="cookie-card">
            <span class="title">🙋 ${info.nombres}</span>
            ...
            <div class="btnEditDelete">
                ...
                <button class="delete-button eliminar" id="${info.idIdentificacion}">
...
async function getInfo(e){
    if (e.target.classList.contains("update")) {
        ...
        informacion.forEach(info => {
            const {idIdentificacion,nombres,email,nroCelular, direccion, idBarrio} = info;
    
            const nombreEdit = document.querySelector('#nombreEdit');
            const emailEdit = document.querySelector('#emailEdit');
            const nroCelularEdit = document.querySelector('#nroCelularEdit');
            const direccionEdit = document.querySelector('#direccionEdit');
            const idBarrioEdit = document.querySelector('#idBarrioEdit');
            const idEdit = document.querySelector('#idEdit');
    
            nombreEdit.value = nombres;
            emailEdit.value = email;
            nroCelularEdit.value = nroCelular;
            direccionEdit.value = direccion;
            idBarrioEdit.value = idBarrio;
            idEdit.value = idIdentificacion;
        });
    }
};
...
function actualizar(e){
    ...
    const nroCelular = document.querySelector('#nroCelularEdit').value;
    const direccion = document.querySelector('#direccionEdit').value;
    const idBarrio = document.querySelector('#idBarrioEdit').value;
